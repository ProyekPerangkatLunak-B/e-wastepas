    ...
    <div class="py-8 ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 px-12 bg-white">
            ...
            <div class="px-12 mt-8 ">
                ...
                <!-- Chart: Top Jenis Sampah Per Kategori-->
                <button class="bg-white p-4 rounded-lg shadow-md text-left w-full hover:bg-[#e2ede0] focus:outline-none focus:ring-2 focus:ring-[#437252] relative">
                    <a href="{{ route('manajemen.datamaster.kategori.index') }}">
                        ...
                        <span class="absolute bottom-6 right-16 text-lg font-semibold text-gray-500 underline">Lainnya...</span>
                    </a>
                </button>
