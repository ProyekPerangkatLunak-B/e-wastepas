...
@section('content')
    ...
    <div class="container max-w-full px-4 mx-auto bg-gray-100">
        <div class="py-1">
            {{-- Section Judul --}}
            <h2 class="text-xl font-semibold leading-relaxed ml-14">Riwayat Penjemputan Sampah</h2>
            <h4 class="text-base font-normal ml-14">Daftar Riwayat penjemputan sampah elektronik</h4>
            ...
            <!-- Card -->
                <div class="bg-white pt-6 pb-6 mx-8 rounded-lg shadow-lg flex flex-col items-center">
                    ...
                    <h5 class="text-gray-600 font-bold text-center text-sm mb-2">Nama Masyarakat</h5>
                    ...
                    <h5 class="text-gray-600 rounded-lg font-normal text-center text-xs mx-5 mb-2 px-5 ">Alamat Lengkap Lokasi Penjemputan</h5>
                    <div class="mt-2 flex items-center justify-center">
                    ...
                    <h5 class="text-gray-600 rounded-lg font-normal text-center text-xs mx-5 mb-2 px-5 ">Alamat Lengkap Dropbox Terdekat dari Lokasi Kurir</h5>
