...
@section('content')
    ...
    <div class="container max-w-full px-4 mx-auto bg-gray-100">
        <div class="py-8">
            <h2 class="text-2xl font-semibold leading-relaxed ml-14">Dashboard Daerah</h2>
            <h4 class="text-base font-normal ml-14">Selamat datang di dashboard daerah.</h4>
                ...
                <table class="min-w-full bg-white border rounded-lg">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="px-4 py-2 border-b text-left text-gray-600">Daerah</th>
    ...
    <div id="addDataModal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black bg-opacity-70">
        <div class="bg-white rounded-lg p-6 w-1/3 shadow-lg" style="background-color: white">
            ...
            <div class="flex flex-col space-y-4 mt-4">
                ...
                <div class="flex flex-col">
                    <label for="daerah" class="mb-1 font-medium text-gray-700">Daerah</label>
                    <select id="daerah"
                        class="w-full p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500">
    ...
    <script>
        ...
        function saveData() {
            ...
            if (!namaDropbox || !daerah || !totalTransaksi) {
