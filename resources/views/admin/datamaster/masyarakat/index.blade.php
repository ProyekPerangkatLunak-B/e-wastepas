                    ...
                    <div class="overflow-x-auto bg-white rounded-lg shadow-md">
                        <table id="daerahTable" class="w-full border border-gray-300 bg-white rounded-lg">
                            <thead class="bg-gray-100">
                                <tr>
                                    <th class="border px-4 py-2 text-left text-sm font-semibold text-white">Nama Pelanggan</th>
                                    <th class="border px-4 py-2 text-left text-sm font-semibold text-white">Email Pelanggan
                                    </th>
