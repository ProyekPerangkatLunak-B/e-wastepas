        ...
        <div class="container px-4 mx-auto py-8">
            ...
            <ul>
                ...
                <div class="bg-[#F7F7F7] border border-[#C0C0C0] rounded-lg p-6 shadow-sm relative mb-6">
                    <a  id="editButton" class="absolute top-4 right-4 z-10 flex items-center gap-2 font-light text-gray-600 py-2 px-4 rounded-md 
                    ...
                    <div class="flex flex-wrap md:flex-nowrap items-start gap-6">
                        <div class="w-24 h-24 rounded-full overflow-hidden bg-gray-200">
                                 ...
                                 <input id="photoInput" name="photo" type="file" class="hidden" accept=".jpg,.jpeg,.png" onchange="previewImage(event)" />
                                    <label for="photoInput" class="cursor-pointer">
                                    @if(isset($user->foto_profil))
                                        <img id="profilePhoto" src="{{ asset('storage/' . $user->foto_profil) }}" alt="Profile Photo" class="w-full h-full object-cover" />
                                    @else
                                ...
                                <div class="relative mt-2">
                                    <input id="nameInput" name="name" type="text" placeholder="Masukkan Nama" class="text-2xl font-semibold text-gray-900 w-full mt-2 px-5 py-4 rounded-2xl bg-gray-100 text-md focus:outline-none focus:bg-white" value="{{ $user->nama }}" readonly />
                                </div>
                            </div>
                ...
                <div class="bg-[#F9F9F9] border border-[#E0E0E0] rounded-lg p-6 shadow-sm relative mt-6">
                    <h5 class="text-xl font-semibold text-gray-900 mb-5">Data Diri</h5>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    ...
                                    <div class="relative mt-2">
                                        <input id="email" name="email" type="email" placeholder="Masukkan Email" class="w-full mt-2 px-5 py-4 rounded-2xl font-medium bg-gray-100 text-md focus:outline-none focus:bg-white" value="{{ $user ->email}}" readonly />
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <label for="phone" class="block mt-2 text-sm font-medium leading-7 text-gray-500">No. HP</label>
                                    <div class="relative mt-2">
                                        <input id="phone" name="phone" type="tel" placeholder="Masukkan No.HP" class="w-full mt-2 px-5 py-4 rounded-2xl font-medium bg-gray-100 text-md focus:outline-none focus:bg-white" value="{{ $user-> nomor_telepon }}" readonly />
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <label for="address" class="block mt-2 text-sm font-medium leading-7 text-gray-500">Alamat</label>
                                    <div class="relative mt-2">
                                        <input id="address" name="address" type="text" placeholder="Masukkan Alamat" class="w-full mt-2 px-5 py-4 rounded-2xl font-medium bg-gray-100 text-md focus:outline-none focus:bg-white" value="{{ $user-> alamat }}" readonly />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative mt-2">
                                        <input id="noRekening" name="noRekening" type="text" placeholder="Masukkan No Rekening" class="w-full mt-2 px-5 py-4 rounded-2xl font-medium bg-gray-100 text-md focus:outline-none focus:bg-white" value="{{ $user-> no_rekening }}" readonly />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 flex justify-end space-x-4">
                            ...
                            <button type="submit" id="saveButton" style="display:none;" class="w-full sm:w-32  bg-gradient-to-r from-green-500 to-green-700 text-[#FFFFFF] py-2 px-4 rounded-md 
