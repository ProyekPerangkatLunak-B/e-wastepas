    ...
    <div class="bg-cover bg-center min-h-screen relative flex items-center justify-center p-4"
        ...
        <div name="email-verification-modal"
            ...
            <div
                ...
                <p class="text-gray-700 mt-4 text-lg">Kami akan mengirimkan OTP ke email Anda. Silakan periksa kotak masuk
                    Anda.
                </p>
                ...
                <div class="text-center mt-3 sm:mt-4">
                    <p class="text-gray-600 text-lg sm:text-lg">Tidak menerima email?
                        <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Kirim
                            Ulang</a>
                    </p>
                </div>
            </div>
