...
<div class="bg-cover bg-center min-h-screen relative flex items-center justify-center p-4" style="background-image: url('/img/mitra-kurir/bg-otp.png');">
    ...
    <div style="background-color: white;" 
        ...
        <div class="flex justify-center mb-4">
            <a href="{{ route('mitra-kurir.penjemputan.kategori') }}" onclick="closeModal()" class="mt-6 px-4 py-2 bg-gradient-to-r from-green-500 to-green-700 text-[#FFFFFF] rounded-md hover:bg-gradient-to-r hover:from-green-600 hover:to-green-800 transition-all duration-300 ease-in-out transform hover:scale-105">Selesai</a>
        </div>
    </div>
</div>
@endsection
