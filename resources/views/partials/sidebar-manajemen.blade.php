    ...
    <div class="p-6">
        ...
        <nav class="mb-8">
            ...
            <ul class="space-y-2">
                <li>
                    <a href="#"
                        class="flex items-center justify-between p-3 text-sm font-medium text-gray-700 border 'bg-gray-100 border-green-400 text-green-600' : 'border-gray-300 hover:bg-gray-200' }} rounded-lg">
                        Kategori Sampah Elektronik
                        <span
                            class="text-lg 'text-green-600' : 'text-gray-400' }}">&gt;</span>
                    </a>
                </li>
                <li>
                    <a href="#"
