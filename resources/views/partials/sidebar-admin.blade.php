    ...
    <div class="p-6">
        ...
        <nav class="mb-6">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('admin.penjemputan.permintaan.index') }}"
                ...
                <li>
                    <a href="{{ route('admin.penjemputan.penerimaan.index') }}"
                ...
                <li>
                    <a href="{{ route('admin.penjemputan.tracking.index') }}"
                ...
                <li>
                    <a href="{{ route('admin.penjemputan.total.index') }}"
                ...
                <li>
                    <a href="{{ route('admin.penjemputan.riwayat.index') }}"
