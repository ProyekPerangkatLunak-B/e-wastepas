        ...
        <div class="relative flex items-center space-x-2">
            ...
            <button @click="dropdownOpen = !dropdownOpen" class="flex items-center space-x-2 focus:outline-none">
                ...
                <div class="flex flex-col items-end">
                    <p class="font-bold text-gray-700">{{ $user->nama }}</p>
                    @if ($user->id_peran == 3)
                        <span class="text-sm text-gray-500">Mitra Kurir</span>
                    @elseif ($user->id_peran == 2)
                        <span class="text-sm text-gray-500">Masyarakat</span>
                    @else
                        <span class="text-sm text-gray-500">Role tidak dikenal</span>
                    @endif

                </div>
                <!-- Dummy Profile Picture -->
                @if (isset($user->foto_profil))
                    <img id="profilePhoto" src="{{ asset('storage/' . $user->foto_profil) }}" alt="Profile Photo"
                ...
                @else
                    <img id="profilePhoto" src="{{ asset('/img/mitra-kurir/icon-account.png') }}"
                        alt="Default Profile Photo" class="border border-green-300 rounded-full shadow-sm w-14 h-14" />
                @endif
...
<<<<<<< HEAD
                    ...
                    <a href={{ route('mitra-kurir.registrasi.account-profile.profile') }}
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            class="text-secondary-normal bi bi-person" viewBox="0 0 16 16">
                            <path
                                d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                        </svg>
                        <span class="font-semibold text-md text-black-normal">Profile</span>
                        <svg class="w-[22px] h-[24px] relative left-40 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="#"
                        ...
                        <svg class="w-[22px] h-[24px] relative left-[150px] text-gray-400"
                    ...
                    <form action="{{ route('mitra-kurir.registrasi.logout') }}" method="POST">
                        ...
                        <button type="submit"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                                class="bi bi-box-arrow-right text-white-normal" viewBox="0 0 16 16">
...
=======
                    @if ($user->id_peran == 3)
                        <a href="{{ route('mitra-kurir.registrasi.account-profile.profile') }}"
                            ...
                            <span class="font-semibold text-md text-black-normal">Profile</span>
                            <svg class="w-[22px] h-[24px] relative left-40 text-gray-400"
                        ...
                        <!-- Settings Link -->
                        <a href="{{ route('mitra-kurir.registrasi.account-profile.security') }}"
                            class="flex items-center px-8 py-3 space-x-3 text-sm border-b border-gray-200 text-secondary-normal hover:bg-gray-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                                class="bi bi-gear" viewBox="0 0 16 16">
                                <path
                        ...
                        <form action="{{ route('mitra-kurir.registrasi.logout') }}" method="POST">
                            ...
                            <button type="submit"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                    fill="currentColor" class="bi bi-box-arrow-right text-white-normal"
                                    viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z" />
                                    <path fill-rule="evenodd"
                    ...
                    @else
                        <a href="{{ route('mitra-kurir.registrasi.account-profile.profile') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                fill="currentColor" class="text-secondary-normal bi bi-person" viewBox="0 0 16 16">
                                <path
                                    d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                            </svg>
                            <span class="font-semibold text-md text-black-normal">Profile</span>
