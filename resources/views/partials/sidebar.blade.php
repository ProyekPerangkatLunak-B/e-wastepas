            ...
            <ul class="space-y-4">
                ...
                <li>
                    <a href="{{ route('masyarakat.penjemputan.permintaan') }}"
                        class="flex items-center justify-between p-3 text-sm bg-gray-100 font-semibold border rounded-2xl {{ Request::is('masyarakat/penjemputan-sampah/permintaan-penjemputan') ? 'bg-gray-100 border-green-400 text-green-600' : 'border-gray-300 text-gray-700 hover:bg-gray-100 hover:text-green-600' }}">
                ...
                <li>
                    <a href="{{ route('masyarakat.penjemputan.melacak') }}"
                        class="flex items-center justify-between p-3 text-sm bg-gray-100 font-semibold border rounded-2xl {{ Request::is('masyarakat/penjemputan-sampah/melacak-penjemputan*') || Request::is('masyarakat/penjemputan-sampah/detail-melacak*') ? 'bg-gray-100 border-green-400 text-green-600' : 'border-gray-300 text-gray-700 hover:bg-gray-100 hover:text-green-600' }}">
                        Melacak Penjemputan
