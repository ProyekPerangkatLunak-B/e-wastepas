...
<div class="w-[83%] min-h-screen px-[5rem] py-14 mx-[22rem] bg-gray-100">
    <div class="flex justify-between">
        ...
        <div class="grid grid-cols-1 gap-6 mt-6 ">
            <!-- Card Total Sampah -->
            <div class="flex flex-col items-center w-4/5 p-8 shadow-lg bg-white-normal rounded-xl group hover:shadow-xl">
                    ...
                    @else
                        @foreach ($penjemputan as $p)
                            <a href="{{ route('masyarakat.penjemputan.detail-riwayat') }}" class="block">
                                <div class="relative flex flex-col justify-between h-[230px] bg-white-normal shadow-md rounded-xl hover:shadow-lg">
                                    <!-- Waktu Penjemputan -->
