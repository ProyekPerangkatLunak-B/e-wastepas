...
<div class="w-[83%] min-h-screen px-[5rem] py-12 mx-[22rem] bg-gray-100">
            ...
            <form method="GET" action="{{ route('masyarakat.penjemputan.melacak') }}">
                ...
                <div class="relative">
                    <input type="text"
                        ...
                        placeholder="Cari di jenis sampah..." name="search" type="text" value="{{ request('search') }}">
                    <!-- SVG Icon Search -->
                ...
                <div class="flex px-6 space-x-6">
                    ...
                    <div class="flex flex-col items-center justify-between">
                        ...
                        <div class="absolute right-0 bottom-1">
                            <span class="px-10 py-2 font-semibold text-white-normal rounded-tl-3xl rounded-br-xl
                                            @switch($p->getLatestPelacakan->status)
                                                @case('Dijemput Kurir')
                                                @case('Menuju Lokasi Penjemputan')
                                                @case('Sampah Diangkut')
    ...
    <div class="flex items-center justify-end pr-4 mt-4 space-x-2">
        {{-- Button < & << --}} @if ($penjemputan->currentPage() > 1)
            ...
            {{-- Nomor halaman --}}
            <button class="px-3 py-1 font-bold text-green-700 bg-green-200 w-[50px] h-[50px] rounded-xl">{{
