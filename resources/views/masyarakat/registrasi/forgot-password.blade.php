    ...
    <div class="min-h-screen bg-white text-gray-900 flex justify-center item-center w-full">
        ...
        <div class="md:w-1/2 sm:p-12">
            <div class="mt-10 flex flex-col items-center">
                <div class="">
                    <h2 class="text-center text-2xl mt-2 font-bold leading-9 tracking-tight text-gray-900">lupa kata sandi
                    </h2>
                    <p class="mt-2 text-center text-sm text-gray-500">Masukkan alamat email anda di bawah ini, dan kami akan
                    <p class="text-center text-sm text-gray-500"> mengirimkan tautan untuk mengatur ulang kata sandi Anda!!
                    </p>
                    </p>
                </div>
                ...
                <div class="w-full flex-20 mt-4">
                    ...
                    <div class="mx-auto max-w-md">
                        <form action="{{ route('masyarakat.password.email') }}" method="POST">
                            ...
                            <!-- Button Submit -->
                            <button
                                class="focus:outline-none text-slate-50 bg-gradient-to-r from-lime-500 to-green-600 hover:bg-gradient-to-l w-full py-4 font-bold rounded-lg mt-8 text-base">
                                Masuk
                            </button>
                        </form>
                    </div>
