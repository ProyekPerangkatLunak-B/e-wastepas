                    ...
                    <form action="{{ route('masyarakat.register.submit') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text" required name="name" placeholder="Masukkan Nama" value="{{ old('name') }}" />
                            @error('name')
                        ...
                        <div>
                            ...
                            <input
                                class="w-full mt-2 px-4 py-2 rounded-lg font-medium bg-gray-100 border border-gray-300 text-md focus:outline-none focus:border-green-800 focus:bg-white"
                                type="tel" required name="tel" placeholder="Masukkan No. Telepon" value="{{ old('tel') }}" />
                            @error('tel')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        <div>
                            <label for="nomor_ktp" class="block mt-4 text-md font-medium leading-9 text-gray-500">No.
                                KTP</label>
                            <input
                                class="w-full mt-2 px-4 py-2 rounded-lg font-medium bg-gray-100 border border-gray-300 text-md focus:outline-none focus:border-green-800 focus:bg-white"
                                type="text" required name="nomor_ktp" placeholder="Masukkan KTP" value="{{ old('nomor_ktp') }}" />
                            @error('nomor_ktp')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
