    ...
    <div class="w-full min-h-screen text-gray-900 bg-white">
        ...
        <div class="items-center mt-32">
            ...
            <div class="max-w-md mx-auto">
                <form id="otpForm" action="{{ route('masyarakat.otp.verify') }}" method="POST">
                    @csrf
                    <input type="hidden" name="otp" id="otpInput">
                    <div class="grid grid-cols-6  mt-10 ms-6 gap-x-10 my-2">
                        <div contenteditable="true"
                            class="otp-field rounded-lg shadow-lg bg-gray-100 cursor-text w-14 aspect-square flex items-center justify-center">
                        ...
                        <!-- Button Submit -->
                        <button type="submit"
                            class="h-12 font-bold rounded-lg mt-14 ms-12 w-80 focus:outline-none text-slate-50 bg-gradient-to-r from-lime-500 to-green-600 hover:bg-gradient-to-l"
                            onclick="collectOtp()">
                            Kirim
                        </button>
                        <div id="modelConfirm"
                            ...
                            <div class="relative max-w-md mx-auto bg-gray-100 rounded-lg shadow-xl top-40">
                                ...
                                <div class="p-6 pt-0 text-center">
                                    ...
                                    <div class="mail-reset">
                                        ...
                                        <h3 class="mt-5 mb-6 font-medium text-gray-500 text-md"> Selamat Anda Berhasil
                                            Melakukan Konfirmasi Kode !! </h3>
            ...
            <a href="" class="font-semibold leading-6 text-gray-700 ms-48 text-md hover:text-gray-500">Kirim
                Ulang</a>
        </div>
    </div>
    </div>
