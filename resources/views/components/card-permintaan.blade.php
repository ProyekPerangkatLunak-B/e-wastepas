<div
    ...
    <div class="flex flex-col items-center pb-5 flex-grow">
        ...
        <div class="flex-grow">
            ...
            @endphp --}}
            @php
                $groupData = $items->groupBy(fn($item) => $item->kategori->nama_kategori);
            @endphp
                    ...
                    <li class="mx-5">
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="w-8 h-8 rounded-full" src="https://picsum.photos/700/700"
                                    alt="{{ $kategori }}">
                            </div>
                            <span
                                class="flex-1 ms-3 whitespace-normal break-words text-lg font-normal">{{ $kategori }}</span>
                            <span
                                class="inline-flex items-center justify-center px-2 py-0.5 ms-3 text-base font-medium text-lime-900">{{ $kategoriItems->count() }}
                                Pcs</span>
                        </a>
                    </li>
                </ul>
