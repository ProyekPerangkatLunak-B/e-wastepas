<div class="relative w-[460px] h-auto pb-4 shadow-md bg-white-100 rounded-2xl group hover:shadow-lg">
    ...
    <div class="flex flex-col items-start justify-between h-[calc(100%-228px)] pt-4">
        <div class="flex-grow">
            ...
            <p class="ml-8 mr-8 text-justify text-gray-500 text-md">{{ $description }}</p>
        </div>
