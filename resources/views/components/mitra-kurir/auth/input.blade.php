    ...
    <div class="mt-2 relative">
        ...
        @if($type === 'password')
            ...
            >
                ...
                <svg id="eye-closed-{{ $id }}" class="h-5 w-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#4a4a4a">
...
<div>
    ...
    <div class="mt-2">
        <input id="{{ $id }}" name="{{ $name }}" type="{{ $type }}" placeholder="{{ $placeholder }}" required class="block w-full rounded-lg border border-second-color py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 bg-light-gray sm:text-sm sm:leading-6 pl-3">
    </div>
</div>